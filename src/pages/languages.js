    ...
    case "css":
      ...
      return (
        <>
          <div
            className={
              theme === "light" ? "lang-wrapper_light" : "lang-wrapper"
            }
            style={sideColorCSS}
          >
            <div className="lang-left-col">
              <div
                className={
                  theme === "light" ? "lang-left-bar_light" : "lang-left-bar"
                }
              >
                <div>
            ...
            <div className="lang-main-col">
              ...
              <h3 className="lang-head">
                <span>What is C</span>SS?
              </h3>
              <div>
                <p>
                  ...
                  page. Using CSS, you can control the color of the text, the
                  style of fonts, the spacing between paragraphs, how columns
                  are sized and laid out, what background images or colors are
                  used, layout designs, variations in display for different
                  devices and screen sizes as well as a variety of other
                  effects. CSS is easy to learn and understand but it provides
                ...
                <p>
                  CSS3 is the latest version of the CSS specification. CSS3 adds
                  several new styling features and improvements to enhance the
              ...
              <Link
                ...
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
              >
                Read more about CSS...
              </Link>
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <h3 className="lang-head">
                <span>What is D</span>art?
              </h3>
              <div>
                <p>
                  Dart is a client-optimized language for developing fast apps
                  on any platform. Its goal is to offer the most productive
                  programming language for multi-platform development, paired
                  with a flexible execution runtime platform for app frameworks.
                </p>
                <p>
                  Languages are defined by their technical envelope — the
                  choices made during development that shape the capabilities
                  and strengths of a language. Dart is designed for a technical
                  envelope that is particularly suited to client development,
                  prioritizing both development (sub-second stateful hot reload)
                  and high-quality production experiences across a wide variety
                  of compilation targets (web, mobile, and desktop).
                </p>
                <h4 className="lang-sub-head"> More Info </h4>
                <p>
                  The Flutter framework is a popular, multi-platform UI toolkit
                  that’s powered by the Dart platform, and that provides tooling
                  and UI libraries to build UI experiences that run on iOS,
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://dart.dev/overview" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <div>
                <p>
                  ...
                  <p>
                    ...
                    and so forth to facilitate the sharing of scientific
                ...
                <h4 className="lang-sub-head"> More Info </h4>
                <p>
                  HTML It can be assisted by technologies such as Cascading
                  ...
                  pages. Inclusion of CSS defines the look and layout of
                  content. The World Wide Web Consortium (W3C), former
                  maintainer of the HTML and current maintainer of the CSS
                  ...
                  <p>
                    ...
                    represented a major break with previous markup practices.
                    The purpose of the profound changes to the language was to
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://html.com/html5/#ixzz72XVLQOTF" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <h3 className="lang-head">
                <span>What is J</span>ava?
              </h3>
              <div>
                <p>
                  Java is one of the world's most widely used computer language.
                  Java is a simple, general-purpose, object-oriented,
                  interpreted, robust, secure, architecture-neutral, portable,
                  high-performance, multithreaded computer language. It is
                ...
                <p>
                  ...
                  released by Sun Microsystems in 1995. Java is a programming
                  language built for the age of the Internet. There are lots of
                ...
                <h4 className="lang-sub-head"> More Info </h4>
                <p>
                  Java solves a host of problems software developers encounter,
                  and very easily too!
                  <ul>
                    <li>
                      Your Java programming language is object oriented, yet
                      it's still dead simple.{" "}
                    </li>
                    <li>
                      Your development cycle is much faster because Java
                      technology is interpreted. The
                    ...
                    <li>
                      ...
                      them--they will run without modification on multiple
                      operating systems and hardware architectures.
                    </li>
                    <li>
                      Your applications are robust because the Java runtime
                      environment manages memory for you.
                    </li>
                    <li>
                      Your interactive graphical applications have high
                      performance because multiple concurrent threads of
                      activity in your application are supported by the
                      multithreading built into the Java programming language
                    ...
                    <li>
                      Your end users can trust that your applications are
                      secure, even though they're downloading code from all over
                      the Internet; the Java runtime environment has built-in
                      protection against viruses and tampering.
                    </li>
                  </ul>
                </p>
              </div>
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://www.oracle.com/java/" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
            ...
            <div className="lang-main-col">
              ...
              <div>
                ...
                <p>
                  ...
                  <p>
                    <b>Client-side JavaScript</b> extends the core language by
                    ...
                    page navigation.
                    <br />
                    <b>Server-side JavaScript</b> extends the core language by
                    ...
                    continuity of information from one invocation to another of
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://www.javascript.com/" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <h3 className="lang-head">
                <span>What is J</span>SON?
              </h3>
              <div>
                <p>
                  JavaScript Object Notation (JSON) is a standard text-based
                  format for representing structured data based on JavaScript
                  object syntax. It is commonly used for transmitting data in
                  web applications (e.g., sending some data from the server to
                  the client, so it can be displayed on a web page, or vice
                  versa). You'll come across it quite often, so in this article
                  we give you all you need to work with JSON using JavaScript,
                  including parsing JSON so you can access data within it, and
                  creating JSON.
                </p>
                <h4 className="lang-sub-head"> More Info </h4>
                <p>
                  JSON is a text-based data format following JavaScript object
                  syntax, which was popularized by Douglas Crockford. Even
                  though it closely resembles JavaScript object literal syntax,
                  it can be used independently from JavaScript, and many
                  programming environments feature the ability to read (parse)
                  and generate JSON. JSON exists as a string — useful when you
                  want to transmit data across a network. It needs to be
                  converted to a native JavaScript object when you want to
                  access the data. This is not a big issue — JavaScript provides
                  a global JSON object that has methods available for converting
                  between the two. A JSON string can be stored in its own file,
                  which is basically just a text file with an extension of
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://www.json.org/json-en.html" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <h3 className="lang-head">
                <span>What is J</span>SX?
              </h3>
              <div>
                <p>
                  JSX is an XML/HTML-like syntax used by React that extends
                  ECMAScript so that XML/HTML-like text can co-exist with
                  JavaScript/React code. The syntax is intended to be used by
                  preprocessors (i.e., transpilers like Babel) to transform
                  HTML-like text found in JavaScript files into standard
                  JavaScript objects that a JavaScript engine will parse.
                  <p>
                    Basically, by using JSX you can write concise HTML/XML-like
                    structures (e.g., DOM like tree structures) in the same file
                    as you write JavaScript code, then Babel will transform
                    these expressions into actual JavaScript code. Unlike the
                    past, instead of putting JavaScript into HTML, JSX allows us
                    to put HTML into JavaScript.
                  </p>
                </p>
                <h4 className="lang-sub-head"> More Info </h4>
                <p>
                  <p>
                    JSX is a syntax extension to JavaScript. We recommend using
                    it with React to describe what the UI should look like. JSX
                    may remind you of a template language, but it comes with the
                  ...
                  <p>
                    ...
                    both. We will come back to components in a further section,
                    but if you’re not yet comfortable putting markup in JS, this
                    talk might convince you otherwise. <br />
              ...
              <Link
                to={{
                  pathname: "https://reactjs.org/docs/introducing-jsx.html",
                }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
        ...
        <>
          ...
          >
            ...
            <div className="lang-main-col">
              ...
              <div className="code-block"></div>
              <Link
                to={{ pathname: "https://www.python.org/about" }}
                target="_blank"
                className={
                  theme === "light" ? "lang-read-more_light" : "lang-read-more"
                }
