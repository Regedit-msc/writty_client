    ...
    for (let i = 0; i < files.length; i++) {
      ...
      if (proceed !== false) {
        ...
        reader.onload = function () {
          ...
          profileRef.current.src = `data:image/${
            file.type.toString().split("/")[1]
          };base64,${base64}`;
      ...
      <div id="main">
        ...
        <div>
          <div id={theme === "light" ? "form1_light" : "form1"}>
            <input
              type="text"
              id={theme === "light" ? "Name_light" : "Name"}
              name="Name"
              placeholder="NAME"
            />
            <input
              type="email"
              id={theme === "light" ? "Email_light" : "Email"}
              name="Email"
              placeholder="EMAIL"
            />
            <input
              type="password"
              id={theme === "light" ? "Password_light" : "Password"}
              name="Password"
