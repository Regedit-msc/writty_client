    ...
    <>
      {results.length > 0 ? (
            ...
            <section className="feed-body">
              <section className="banner-container">
                ...
                <p className="banner-message">
                  Hope you can see other users' gists code snippets, featured
                  people and lots more. Enjoy!
                </p>
                <span>DISMISS</span>
              </section>
              <section className="create-post">
                <img src={Jorja} alt="profile" />
                <div className="text-editor">
                  <div id="add-badge">Add badge</div>
                  <div id="message-wrap">
                    <textarea placeholder="Write something..."></textarea>
                    <div id="send-circle">
                      <img src={Send} id="send-img" alt="send" />
                    </div>
                  </div>
              ...
              <section className="post image">
                ...
                <div className="post-main">
                  <div className="post-description">
                    ...
                    portfolio. Though putting one together might seem like a
                    huge task, once you get an idea of what makes a great
                    portfolio it’ll come easy. And the fastest way to get that
                    idea is to look up inspiration.
                  </div>
                  <img
                    src={PostImage}
              ...
              <section className="post article">
                ...
                <div className="post-main">
                  ...
                  <div className="post-description">
                    ...
                    huge task, once you get an idea of what makes a great
                    portfolio it’ll come easy. And the fastest way to get that
                    idea is to look up inspiration. User Interface Design is a
                    crucial subset of UX. They both share the same end goal—to
                    provide a positive experience for the user—but UI Design
                    comprises an entirely separate leg of the journey. Put
                    simply, UI is what you use to interact with a product, while
                    UX is concerned with how this overall interaction feels.
                    We’ve already written extensively about the differences
                    between user experience (UX) and user interface (UI) design,
                    so from now on we’ll focus solely on UI. If, after reading
                    all about the role of a UI designer, you feel inclined to
                    become one, be sure to move gracefully over to senior UI
                    designer Eric Bieller’s step-by-step guide on how to do
                    exactly that, or watch the video tutorial below in which UI
                    design mentor Elizé gives you a hands-on, practical
                    introduction to the world of user interface design. To
                    access all her tutorials, simply sign up here, or subscribe
                    to the CareerFoundry YouTube channel. So, all UX designers –
                    juniors and seniors alike – need a UX portfolio. Though
                    putting one together might seem like a huge task, once you
                    get an idea of what makes a great portfolio it’ll come easy.
                    And the fastest way to get that idea is to look up
                    inspiration. User Interface Design is a crucial subset of
                    UX. They both share the same end goal.
                  </div>
                </div>
                <div className="post-actions">
                  <div>
        ...
        <>
          ...
          <section className="create-post">
            <img src={localStorage.getItem("profile_user_pic")} alt="profile" />
            <div className="text-editor">
              <div id="add-badge">Add badge</div>
              <div id="message-wrap">
                <textarea placeholder="Write something..."></textarea>
